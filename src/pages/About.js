        ...
        <div className="centered">
          <div className="name_title">Michael Crabb</div>
            <div className="brief_description">
                ...
                study computer science and mathematics and feel so priviaged to be here with you all. My interests vary,
                I am insanely captivated by the Earth, I have many plans of traveling the world and seeing how it can
                suprise me next and I enjoy playing video games with my friends.
            </div>
          </div>
        </div>
      </div>
